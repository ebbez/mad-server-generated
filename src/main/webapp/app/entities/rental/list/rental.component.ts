...
import { EntityArrayResponseType, RentalService } from '../service/rental.service';
...
export class RentalComponent implements OnInit {
  ...
  delete(rental: IRental): void {
    const modalRef = this.modalService.open(RentalDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.rentalService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
