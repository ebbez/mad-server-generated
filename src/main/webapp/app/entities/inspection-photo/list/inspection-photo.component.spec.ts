...
import { sampleWithRequiredData } from '../inspection-photo.test-samples';
...
describe('InspectionPhoto Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [InspectionPhotoComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.inspectionPhotos()[0]).toEqual(expect.objectContaining({ id: 31807 }));
  });

  describe('trackId', () => {
    it('should forward to inspectionPhotoService', () => {
      const entity = { id: 31807 };
