...
import nl.hanze.se4.automaat.service.LocationService;
...
/**
 * REST controller for managing {@link nl.hanze.se4.automaat.domain.Location}.
 */
@RestController
...
public class LocationResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Location>> getAllLocations(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
